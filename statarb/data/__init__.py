...
D2  Continuous futures builder, which lives in the shared platform repo. Per contract
    series where free sources allow, otherwise documented source rolls. Own rolls at
    N = 5 business days before expiry, back adjusted additive, with the unadjusted series
    retained rather than discarded. Roll calendars per market.
